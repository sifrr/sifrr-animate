...
describe('Bezier', function() {
  ...
  it('returns memoized values', async () => {
    const bezier1 = new Bezier([.1,.9,.3,.7]);
    const bezier2 = new Bezier([0.1,.9,.3,.7]);
    const bezier3 = new Bezier([.1,.9,0.3,.7]);
